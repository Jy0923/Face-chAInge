...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--Arc_path", type=str, default='./weights/arcface_checkpoint.tar', help="run ONNX model via TRT")
        self.parser.add_argument("--source", type=str, default='./source.jpg', help="Person who provides identity information")
        self.parser.add_argument("--target", type=str, default='./target.jpg', help="Person who provides information other than their identity")
        self.parser.add_argument("--pic_specific_path", type=str, default='./crop_224/zrf.jpg', help="The specific person to be swapped")
        self.parser.add_argument("--multisepcific_dir", type=str, default='./images/multispecific', help="Dir for multi specific")
        ...
        self.parser.add_argument("--output_path", type=str, default='./images/', help="results path")
