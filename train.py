...
def get_args():
    ...
    parser.add_argument('--data_path', type=str, default = "./data/widerface", help='Path for dataset,default WIDERFACE')
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        for iter_num,data in enumerate(dataloader_train):
            optimizer.zero_grad()
            classification_loss, bbox_regression_loss,ldm_regression_loss = retinaface([data['img'].float(), data['annot']])#.cuda()
