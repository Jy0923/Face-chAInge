...
def predict_age_gender_race(home_dir, image_files):
    ...
    model_fair_7.load_state_dict(torch.load(os.path.join(home_dir, 'weights/res34_fair_align_multi_7_20190809.pt')))
    model_fair_7 = model_fair_7.cpu()
    model_fair_7.eval()
    model_fair_4 = torchvision.models.resnet34(pretrained=True)
    model_fair_4.fc = nn.Linear(model_fair_4.fc.in_features, 18)
    model_fair_4.load_state_dict(torch.load(os.path.join(home_dir, 'weights/fairface_alldata_4race_20191111.pt')))
